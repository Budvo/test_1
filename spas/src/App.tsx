...
const ALL_QUESTIONS: Question[] = [
  ...
  },
  {
  ...
  },
   {
    ...
    options: [
      ...
      { id: "b", text: "Действия пожарных подразделений направленные на полное прекращение огня, а так же на исключение возможности его повторного возникновения", isCorrect: false },
      { id: "c", text: "Действия, направленные на спасение людей, имущества и ликвидацию пожаров", isCorrect: true },
  ...
  },
   {
    ...
    options: [
      ...
      { id: "c", text: "В случае выражения сомнения в надежности стабилизации автомобиля хотя бы одним из участников спасательных работ", isCorrect:  },
    ],
  },
  {
    id: 13,
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "Не разрешается", isCorrect: false },
      { id: "c", text: "Разрешается при согласовании с руководителем работ и предупреждении остальных работающих", isCorrect: true },
    ],
  },
  {
    id: 17,
    ...
    options: [
      { id: "a", text: "Химические, термические, радиационные, электрические", isCorrect: false },
      { id: "b", text: "Химические, электрические, щелочные, термические", isCorrect: false },
      { id: "c", text: "Электрические, щелочные, кислотные, радиационные, термические", isCorrect: true },
    ],
  },
  {
    id: 18,
  ...
  },
  {
    ...
    options: [
      { id: "a", text: "Пожары металлов и их сплавов", isCorrect: false },
      { id: "b", text: "Пожары газов", isCorrect: false },
